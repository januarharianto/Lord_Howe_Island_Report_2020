					...
					<tbody id="CTRL2">
						<xsl:for-each select="Catch">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="SPC_Code"/>
								</td>
								<td>
									<xsl:value-of select="CAT_Length"/>
								</td>
								<td>
									<xsl:value-of select="CAT_Count"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CAT_Kept_YN', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="CAT_Notes"/>
								</td>
								<td>
