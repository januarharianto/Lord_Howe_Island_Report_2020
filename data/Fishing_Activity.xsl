	...
	<xsl:template match="//dataroot" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
		<html>
			<head>
				...
				<title>Fishing_Activity</title>
				<style type="text/css"></style>
			</head>
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						<col style="TEXT-ALIGN: right; WIDTH: 1.728cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.763cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="WIDTH: 3.227cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.134cm"/>
						<col style="WIDTH: 1.093cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.375cm"/>
						<col style="WIDTH: 1.269cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.322cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.922cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="WIDTH: 4.179cm"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
								<div align="center">
									<strong>FAC_ID</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Data issue notes</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Fishing_Activity">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="VSL_ID"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('FAC_Date', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="FAC_Location"/>
								</td>
								<td>
									<xsl:value-of select="FAC_Hours"/>
								</td>
								<td>
									<xsl:value-of select="CREATED_BY"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CREATED_ON', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="MODIFIED_BY"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('MODIFIED_ON', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="FAC_Passengers"/>
								</td>
								<td>
									<xsl:value-of select="FAC_Lines"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('DATA_x0020_ISSUE', 'Yes/No', '', '', 11)"/>
								</td>
								<td>
									<xsl:value-of select="Data_x0020_issue_x0020_notes"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
